...
def get_request_summary(window_minutes: int = 60) -> dict:
...
def get_timeline(window_minutes: int = 60, buckets: int = 10) -> list[dict]:
    ...
    for i in range(buckets):
        ...
        req_per_min = len(bucket_requests) / bucket_size_minutes if bucket_size_minutes > 0 else 0
